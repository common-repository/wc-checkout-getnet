...
return [
	...
	'providers'           => [
		...
		\WcGetnet\WooCommerce\GateWays\AdminSettingsFields\Admin::class,
		\WcGetnet\WooCommerce\GateWays\WCGetnet_CreditCardFee::class,
		\WcGetnet\WooCommerce\WcGetnetLogsProvider::class,
		\WcGetnet\WooCommerce\OrderServiceProvider::class,
	],
